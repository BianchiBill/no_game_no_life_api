...
const sora = {
  ...
  gender: 'Male',
  race: ' Human',
  history: 'Abandoned by his parents, Sora is a brilliant NEET (Not in Education, Employment, or Training) hikikomori (shut-in) gamer along with his stepsister, Shiro. He does not take life very seriously and is pretty much a good-for-nothing gamer. One day, he and his sister are called into an alternate world and they have to become Saviors of Humanity!\nDespite being a NEET and a shut-in, Sora is extremely outgoing and confident, and is not afraid to play games with people face to face, even when they\'re cheating. He is also extremely manipulative - which he refers to as using negotiating skills. This fits in with his play style as while Shiro is excellent at logic and computing, Sora can read people and predict what their next move is, using this knowledge to beat them.\nHowever, if he is separated from Shiro by so much as a closed door he becomes a spineless, cowardly wreck, and only returns to his former self if he is able to see her. He views his sister as his equal and partner, but is also protective of her, shown by actions such as putting his body between her and the ground when he thought they were going to hit hard when first arriving on Disboard.\nSora is extroverted and has no problems dealing with people. While not as intelligent as Shiro, he is shown to have a brilliant IQ. Rather than computing numbers like Shiro, Sora can rapidly compute what his opponents are going to do based on observing their behavior and motivations.\nSora is also slightly perverted and desires a girlfriend for himself. His lust lead to a linguistic mistake that causes Stephanie to fall in love with him and causes him to receive a scolding from Shiro.',
};
...
const shiro = {
  ...
  gender: 'Female',
  race: 'Human',
  history: 'Shiro is the main female protagonist. She\'s a genius NEET (Not in Education, Employment, or Training) hikikomori (shut-in) gamer along with her step-brother, Sora and together they formed 『　　』. Between both siblings she is the calm and collective half which makes her the brain of the group.',
};
...
const stephanie_dola = {
  ...
  gender:'Female',
  race: 'Imanity',
  history: 'Stephanie is expressive and emotional, to the point where she cannot hide her emotions during a poker game. She loved her grandfather dearly and is angered when people call her grandfather a fool. She fell in love with Sora due to the pledges forcing her to, and she often has violent outbursts to try to break free of it. She loves her kingdom and the world and believes in the potential of Imanity.',
};
...
const jibril = {
  ...
  gender:'Female',
  race:' Flügel',
  history: `Jibril is the youngest and strongest of the Flügel race. Her love toward knowledge starts even before the declaration of the Ten Oaths. She is against the book sharing law, and left her homeland to win the main library of the human world from the previous king in a game.

Unlike Steph, Jibril is happy to become the siblings underling, and is shown growing feelings toward Sora.`,
};
...
const clammy_zell = {
  ...
  gender:'Female',
  race: 'Imanity',
  history: 'A human who allied with several different races in order to win the king\'s contest, due to her belief that humans will never be strong and must depend on others in order to survive.',
};
...
const fiel_nilvalen = {
  ...
  gender:'Female',
  race: 'Elf',
  history:'Fiel Nilvalen who usually has her name shortened to Fii, is an Elf girl who is Chlammy Zell\'s game partner, as well as the one who helps her cheat using her elven magic. She is very protective of Chlammy and would go to great lengths to keep her safe. She is a hexa-caster (able to cast and maintain up to six spells at once), a very rare capability that only an extraordinary few possess. She is part of the Nilvalen family which may be a factor of her strong magic as a result of being a descendant of Shinku Nilvalen.',
};
